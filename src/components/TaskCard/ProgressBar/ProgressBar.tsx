...
const ProgressBar = ({ total, completed, status }: ProgressBarProps) => {
  ...
  return (
    <div className="mb-2">
      <div className="flex justify-between w-51 mb-1 items-center">
        <div className="w-42 mt-1 h-2.5 relative overflow-hidden bg-gradient-to-r from-cyan-100 to-cyan-700">
            <div 
